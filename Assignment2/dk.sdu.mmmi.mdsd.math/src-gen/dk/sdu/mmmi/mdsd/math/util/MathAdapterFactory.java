...
public class MathAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected MathSwitch<Adapter> modelSwitch =
    ...
    {
      @Override
      public Adapter caseMathScript(MathScript object)
      {
        return createMathScriptAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link dk.sdu.mmmi.mdsd.math.MathScript <em>Script</em>}'.
   * <!-- begin-user-doc -->
   ...
   * @generated
   */
  public Adapter createMathScriptAdapter()
  {
    return null;
  }
  ...
  /**
   * Creates a new adapter for an object of class '{@link dk.sdu.mmmi.mdsd.math.VariableRef <em>Variable Ref</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
