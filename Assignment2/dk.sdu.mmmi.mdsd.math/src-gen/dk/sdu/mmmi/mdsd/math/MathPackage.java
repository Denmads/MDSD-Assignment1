...
public interface MathPackage extends EPackage
{
  ...
  /**
   * The meta object id for the '{@link dk.sdu.mmmi.mdsd.math.impl.MathScriptImpl <em>Script</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see dk.sdu.mmmi.mdsd.math.impl.MathScriptImpl
   * @see dk.sdu.mmmi.mdsd.math.impl.MathPackageImpl#getMathScript()
   * @generated
   */
  int MATH_SCRIPT = 0;
   ...
   * @ordered
   */
  int MATH_SCRIPT_FEATURE_COUNT = 1;
   ...
   * @ordered
   */
  int STATEMENT__NAME = VARIABLE__NAME;
   ...
   * @ordered
   */
  int STATEMENT__EXP = VARIABLE__EXP;
   ...
   * @ordered
   */
  int STATEMENT_FEATURE_COUNT = VARIABLE_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int LOCAL_VARIABLE__NAME = EXPRESSION_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int LOCAL_VARIABLE__EXP = EXPRESSION_FEATURE_COUNT + 1;

  /**
   * The feature id for the '<em><b>Val Exp</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int LOCAL_VARIABLE__VAL_EXP = EXPRESSION_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
  int LOCAL_VARIABLE_FEATURE_COUNT = EXPRESSION_FEATURE_COUNT + 3;
  ...
  /**
   * The meta object id for the '{@link dk.sdu.mmmi.mdsd.math.impl.VariableRefImpl <em>Variable Ref</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see dk.sdu.mmmi.mdsd.math.impl.VariableRefImpl
   * @see dk.sdu.mmmi.mdsd.math.impl.MathPackageImpl#getVariableRef()
   * @generated
   */
  int VARIABLE_REF = 11;
   ...
   * @ordered
   */
  int VARIABLE_REF__VALUE = ATOMIC_FEATURE_COUNT + 0;
  ...
  /**
   * Returns the meta object for class '{@link dk.sdu.mmmi.mdsd.math.MathScript <em>Script</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Script</em>'.
   * @see dk.sdu.mmmi.mdsd.math.MathScript
   * @generated
   */
  EClass getMathScript();

  /**
   * Returns the meta object for the containment reference list '{@link dk.sdu.mmmi.mdsd.math.MathScript#getStatements <em>Statements</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Statements</em>'.
   * @see dk.sdu.mmmi.mdsd.math.MathScript#getStatements()
   * @see #getMathScript()
   * @generated
   */
  EReference getMathScript_Statements();
  ...
  /**
   * Returns the meta object for the containment reference '{@link dk.sdu.mmmi.mdsd.math.LocalVariable#getValExp <em>Val Exp</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Val Exp</em>'.
   * @see dk.sdu.mmmi.mdsd.math.LocalVariable#getValExp()
   * @see #getLocalVariable()
   * @generated
   */
  EReference getLocalVariable_ValExp();
  ...
  /**
   * Returns the meta object for class '{@link dk.sdu.mmmi.mdsd.math.VariableRef <em>Variable Ref</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Variable Ref</em>'.
   * @see dk.sdu.mmmi.mdsd.math.VariableRef
   * @generated
   */
  EClass getVariableRef();

  /**
   * Returns the meta object for the reference '{@link dk.sdu.mmmi.mdsd.math.VariableRef#getValue <em>Value</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>Value</em>'.
   * @see dk.sdu.mmmi.mdsd.math.VariableRef#getValue()
   * @see #getVariableRef()
   * @generated
   */
  ...
  {
    /**
     * The meta object literal for the '{@link dk.sdu.mmmi.mdsd.math.impl.MathScriptImpl <em>Script</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see dk.sdu.mmmi.mdsd.math.impl.MathScriptImpl
     * @see dk.sdu.mmmi.mdsd.math.impl.MathPackageImpl#getMathScript()
     * @generated
     */
    EClass MATH_SCRIPT = eINSTANCE.getMathScript();
     ...
     * @generated
     */
    EReference MATH_SCRIPT__STATEMENTS = eINSTANCE.getMathScript_Statements();
    ...
    /**
     * The meta object literal for the '<em><b>Val Exp</b></em>' containment reference feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference LOCAL_VARIABLE__VAL_EXP = eINSTANCE.getLocalVariable_ValExp();
    ...
    /**
     * The meta object literal for the '{@link dk.sdu.mmmi.mdsd.math.impl.VariableRefImpl <em>Variable Ref</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see dk.sdu.mmmi.mdsd.math.impl.VariableRefImpl
     * @see dk.sdu.mmmi.mdsd.math.impl.MathPackageImpl#getVariableRef()
