...
public class MathPackageImpl extends EPackageImpl implements MathPackage
{
   ...
   * @generated
   */
  private EClass mathScriptEClass = null;
   ...
   */
  @Override
  public EClass getMathScript()
  {
    return mathScriptEClass;
  }
   ...
   */
  @Override
  public EReference getMathScript_Statements()
  {
    return (EReference)mathScriptEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getLocalVariable_ValExp()
  {
  ...
  public void createPackageContents()
  {
    ...
    mathScriptEClass = createEClass(MATH_SCRIPT);
    createEReference(mathScriptEClass, MATH_SCRIPT__STATEMENTS);
    ...
    createEReference(localVariableEClass, LOCAL_VARIABLE__VAL_EXP);
  ...
  public void initializePackageContents()
  {
    ...
    statementEClass.getESuperTypes().add(this.getVariable());
    localVariableEClass.getESuperTypes().add(this.getExpression());
    ...
    initEClass(mathScriptEClass, MathScript.class, "MathScript", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getMathScript_Statements(), this.getStatement(), null, "statements", null, 0, -1, MathScript.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getLocalVariable_ValExp(), this.getExpression(), null, "valExp", null, 0, 1, LocalVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
