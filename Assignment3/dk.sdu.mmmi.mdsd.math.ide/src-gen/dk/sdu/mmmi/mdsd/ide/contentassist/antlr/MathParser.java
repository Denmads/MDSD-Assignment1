...
public class MathParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MathGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getMathProgramAccess().getGroup(), "rule__MathProgram__Group__0");
			...
			builder.put(grammarAccess.getMathProgramAccess().getNameAssignment_1(), "rule__MathProgram__NameAssignment_1");
			builder.put(grammarAccess.getMathProgramAccess().getExternalFunctionsAssignment_2(), "rule__MathProgram__ExternalFunctionsAssignment_2");
			builder.put(grammarAccess.getMathProgramAccess().getVariablesAssignment_3(), "rule__MathProgram__VariablesAssignment_3");
			builder.put(grammarAccess.getExternalDeclarationAccess().getNameAssignment_1(), "rule__ExternalDeclaration__NameAssignment_1");
			builder.put(grammarAccess.getExternalDeclarationAccess().getParametersAssignment_3_0(), "rule__ExternalDeclaration__ParametersAssignment_3_0");
			builder.put(grammarAccess.getExternalDeclarationAccess().getParametersAssignment_3_1_1(), "rule__ExternalDeclaration__ParametersAssignment_3_1_1");
			...
			builder.put(grammarAccess.getExternalCallAccess().getMethodAssignment_0(), "rule__ExternalCall__MethodAssignment_0");
			builder.put(grammarAccess.getExternalCallAccess().getArgumentsAssignment_2_0(), "rule__ExternalCall__ArgumentsAssignment_2_0");
			builder.put(grammarAccess.getExternalCallAccess().getArgumentsAssignment_2_1_1(), "rule__ExternalCall__ArgumentsAssignment_2_1_1");
		}
	}
