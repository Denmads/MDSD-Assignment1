...
public class MathPackageImpl extends EPackageImpl implements MathPackage
{
   ...
   * @generated
   */
  private EClass mathProgramEClass = null;
   ...
   */
  @Override
  public EClass getMathProgram()
  {
    return mathProgramEClass;
  }
   ...
   */
  @Override
  public EAttribute getMathProgram_Name()
  {
    return (EAttribute)mathProgramEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getMathProgram_ExternalFunctions()
  {
    return (EReference)mathProgramEClass.getEStructuralFeatures().get(1);
  }
   ...
   */
  @Override
  public EReference getMathProgram_Variables()
  {
    return (EReference)mathProgramEClass.getEStructuralFeatures().get(2);
  }
   ...
   */
  @Override
  public EReference getExternalDeclaration_Parameters()
  {
   ...
   */
  @Override
  public EReference getExternalCall_Method()
  {
  ...
  public void createPackageContents()
  {
    ...
    mathProgramEClass = createEClass(MATH_PROGRAM);
    createEAttribute(mathProgramEClass, MATH_PROGRAM__NAME);
    createEReference(mathProgramEClass, MATH_PROGRAM__EXTERNAL_FUNCTIONS);
    createEReference(mathProgramEClass, MATH_PROGRAM__VARIABLES);
    ...
    createEReference(externalDeclarationEClass, EXTERNAL_DECLARATION__PARAMETERS);
    ...
    createEReference(externalCallEClass, EXTERNAL_CALL__METHOD);
  ...
  public void initializePackageContents()
  {
    ...
    intTypeEClass.getESuperTypes().add(this.getParameterType());
    ...
    initEClass(mathProgramEClass, MathProgram.class, "MathProgram", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getMathProgram_Name(), ecorePackage.getEString(), "name", null, 0, 1, MathProgram.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getMathProgram_ExternalFunctions(), this.getExternalDeclaration(), null, "externalFunctions", null, 0, -1, MathProgram.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getMathProgram_Variables(), this.getVarBinding(), null, "variables", null, 0, -1, MathProgram.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getExternalDeclaration_Parameters(), this.getParameterType(), null, "parameters", null, 0, -1, ExternalDeclaration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getExternalCall_Method(), this.getExternalDeclaration(), null, "method", null, 0, 1, ExternalCall.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
