...
public class MathSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        MathProgram mathProgram = (MathProgram)theEObject;
        T result = caseMathProgram(mathProgram);
      ...
      case MathPackage.PARAMETER_TYPE:
      {
      ...
      case MathPackage.INT_TYPE:
      {
        ...
        if (result == null) result = caseParameterType(intType);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
   ...
   * @generated
   */
  public T caseMathProgram(MathProgram object)
  {
    return null;
  }
