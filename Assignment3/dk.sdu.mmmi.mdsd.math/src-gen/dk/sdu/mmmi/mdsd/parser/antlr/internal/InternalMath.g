...
// Entry rule entryRuleMathProgram
entryRuleMathProgram returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getMathProgramRule()); }
	iv_ruleMathProgram=ruleMathProgram
	{ $current=$iv_ruleMathProgram.current; }
	EOF;

// Rule MathProgram
ruleMathProgram returns [EObject current=null]
@init {
	enterRule();
}
@after {
