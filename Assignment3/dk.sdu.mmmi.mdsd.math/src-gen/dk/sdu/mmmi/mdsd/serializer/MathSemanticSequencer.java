...
public class MathSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == MathPackage.eINSTANCE)
			...
			case MathPackage.EXTERNAL_DECLARATION:
				...
				return; 
			case MathPackage.INT_TYPE:
				sequence_ParameterType(context, (IntType) semanticObject); 
				return; 
			...
			case MathPackage.MATH_NUMBER:
				...
				return; 
			case MathPackage.MATH_PROGRAM:
				sequence_MathProgram(context, (MathProgram) semanticObject); 
				return; 
	 ...
	 *
	 * Constraint:
	 *     (method=[ExternalDeclaration|ID] (arguments+=Exp arguments+=Exp*)?)
	 * </pre>
	 */
	 ...
	 * <pre>
	 * Contexts:
	 *     MathProgram returns MathProgram
	 *
	 * Constraint:
	 *     (name=ID externalFunctions+=ExternalDeclaration* variables+=VarBinding*)
	 * </pre>
	 */
	protected void sequence_MathProgram(ISerializationContext context, MathProgram semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 * </pre>
	 */
	protected void sequence_ParameterType(ISerializationContext context, IntType semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
