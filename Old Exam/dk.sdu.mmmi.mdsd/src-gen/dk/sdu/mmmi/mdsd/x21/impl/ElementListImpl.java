 ...
 * </p>
 * <ul>
 *   <li>{@link dk.sdu.mmmi.mdsd.x21.impl.ElementListImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ElementListImpl extends MinimalEObjectImpl.Container implements ElementList
{
  ...
  {
    return X21Package.Literals.ELEMENT_LIST;
  }
  ...
  public EList<Element> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<Element>(Element.class, this, X21Package.ELEMENT_LIST__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case X21Package.ELEMENT_LIST__ELEMENTS:
