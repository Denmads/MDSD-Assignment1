...
public class P5Main extends GenericMainX21 {
	...
	///
	private String _active_course;
	public void setParameterActive_course(String value) {
	...
	public void inputTeachers(String input) {
	...
	private ComputeNode<Object, Object> node_0 = new AbstractComputeNode<Object, Object>() {
		protected Object function(Object input) {
			Function<String, Object> f = (String _t) -> { return new DataTeacher().setName(_t.getName()).setAge(_t.getAge()+1).setCourse_taught(_t.getCourse_taught()); };
			return f.apply((String)input);
		}
	}
	///
	...
	private ComputeNode<Object, Object> node_filter = new AbstractComputeNode<Object, Object>() {
		protected Object function(Object input) {
			Function<String, Object> f = (String _t) -> { return _t.getCourse_taught().equals(_active_course)?_t:null; };
			return f.apply((String)input);
		}
	}
	///
	...
	private ComputeNode<Object, Object> node_1 = new AbstractComputeNode<Object, Object>() {
		protected Object function(Object input) {
			Function<String, Object> f = (String _t) -> { return _t.getName(); };
			return f.apply((String)input);
		}
	}
	///
